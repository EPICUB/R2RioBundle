...
use \Epic\R2RioBundle\Entity\R2SearchAgencyRepository as BaseRepository;
use \Epic\R2RioBundle\Entity\R2SearchAgency as BaseEntity;

class R2SearchAgency extends  AbstractServices{

    protected $entityName = "\Epic\R2RioBundle\Entity\R2SearchAgency";
    protected $entityShortcutName = "EpicR2RioBundle:R2SearchAgency";
