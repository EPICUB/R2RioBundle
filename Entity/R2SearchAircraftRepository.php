...
/**
 * R2SearchAircraftRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class R2SearchAircraftRepository extends EntityRepository
{
    public function update(R2SearchAircraft $entity)
    {
        $this->_em->persist($entity);
        $this->_em->flush();
    }

    public function remove(R2SearchAircraft $entity)
    {
    ...
    public function datableElement($response, $start = 0, $limit = 10, $order = array(), $filter ='')
    {
        ...
        if(!empty($order)) {
            switch($order['column']) {
                case 1:
                    $query->addOrderBy('entity.manufacturer',$order['dir']);
                    break;
                case 2:
                    $query->addOrderBy('entity.model',$order['dir']);
                    break;
                default:
    ...
    private function addQueryFilter(QueryBuilder $query, $filter)
    {
        ...
        $query->andWhere($query->expr()->orX(
            ...
            $expr->like('entity.manufacturer',':filter_str'),
            $expr->like('entity.model',':filter_str')
        ));
