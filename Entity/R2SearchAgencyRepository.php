...
/**
 * R2SearchAgencyRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class R2SearchAgencyRepository extends EntityRepository
{
    public function update(R2SearchAgency $entity)
    {
        $this->_em->persist($entity);
        $this->_em->flush();
    }

    public function remove(R2SearchAgency $entity)
    {
        ...
        if(!empty($order)) {
            switch($order['column']) {
                case 1:
                    ...
                    break;
                case 2:
                    $query->addOrderBy('entity.url',$order['dir']);
                    break;
                default:
    ...
    private function addQueryFilter(QueryBuilder $query, $filter)
    {
        ...
        $query->andWhere($query->expr()->orX($expr->like('entity.code',':filter_str'),$expr->like('entity.name',':filter_str')));
