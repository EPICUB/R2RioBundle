...
/**
 * R2SearchAirlineRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class R2SearchAirlineRepository extends EntityRepository
{
    public function update(R2SearchAirline $entity)
    {
        $this->_em->persist($entity);
        $this->_em->flush();
    }

    public function remove(R2SearchAirline $entity)
    {
