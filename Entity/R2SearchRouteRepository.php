...
/**
 * R2SearchRouteRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class R2SearchRouteRepository extends EntityRepository
{
    public function update(R2SearchRoute $entity)
    {
        $this->_em->persist($entity);
        $this->_em->flush();
    }

    public function remove(R2SearchRoute $entity)
    {
    ...
    private function addQueryFilter(QueryBuilder $query, $filter)
    {
        ...
        $query->andWhere($expr->like('entity.name',':filter_str'));
